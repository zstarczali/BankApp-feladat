namespace BankSystem.Web.Areas.CashTransfer.Controllers
{
    ...
    [Area("CashTransfer")]
    public abstract class BaseCashTransferController : BaseController
    {
        private readonly IBankAccountService bankAccountService;

        protected BaseCashTransferController(IBankAccountService bankAccountService, IMapper mapper)
        {
